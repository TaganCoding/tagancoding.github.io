<html>
  ...
  <body>
        ...
        <div id="filterContainer">  
            <div id="openingFilter" class="filter">
                ...
                <select id="opening" onchange="showPlacesList();">
                    ...
                    <option value="0">скоро открытие</option>
                </select>
            </div>
            ...
            <div id="typeFilter" class="filter">
                ...
                <select id="typeDosug" onchange="showPlacesList();">
                    ...
                    <option value="Бизнесланч">Бизнесланч</option>
                    ...
                    <option value="Пивбар">Пивбар</option>
                    <option value="Пивная">Пивная</option>
                    ...
                    <option value="Барная викторина">Барная викторина</option>
            ...
            <div id="banketFilter" class="filter" style="display: none">
                <label>Зал</label>
                <select id="banketzal" onchange="showPlacesList();">
                    <option value="all" selected="selected">любой</option>
                    <option value="30">до 30</option>
                    <option value="60">30-60</option>
                    <option value="90">60-90</option>
                    <option value="100">от 90</option>
                </select>
            </div>
            <div id="letnikFilter" class="filter" style="display: none">
                <label>Летняя площадка</label>
                <input id="letnikInput" type="checkbox" onchange="showPlacesList();" />
            </div>
            ...
            <div id="withAlcoholFilter" class="filter">
                <label>Со своим</label>
                <input id="withAlcoholInput" type="checkbox" onchange="showPlacesList();" />
            </div>
            <div id="nightFilter" class="filter">
                <label>Допоздна</label>
                <input id="nightInput" type="checkbox" onchange="showPlacesList();" />
            </div>
            <div id="danceFloorFilter" class="filter">
                <label>Танцпол</label>
                <input id="danceFloorInput" type="checkbox" onchange="showPlacesList();" />
            </div>
            <div id="discountsFilter" class="filter">
                <label>Скидки</label>
                <input id="discountsInput" type="checkbox" onchange="showPlacesList();" />
            </div>
        </div>
    ...
    <div style="text-align:center;">
        ...
        <a href="http://tagancoding.github.io/" style="float:left;padding-left:10px" target=_blank>IT вакансии</a>
        <a href="http://tagancoding.github.io/ABO.html" style="float:left;padding-left:10px" target=_blank>Базы отдыха</a>
        <a href="http://it.verych.ru/cocktails.html" style="float:left;padding-left:10px" target=_blank>Коктейли</a>
        <a href="http://tagancoding.github.io/RostovPoi.html" style="float:left;padding-left:10px" target=_blank>Ростов</a>
    </div>
    <br /> 
