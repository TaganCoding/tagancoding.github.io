...
PlacesList.prototype.fill = function ()
{
	...
	content += '<th class="bigSizeIconColumn" colspan="25">Ссылки</th>';
	...
	for(var i = 0; i < places.length; i++)
	{
		...
		content += 
		addImageLink("smallSizeIconColumn", "imageLinkWidth", place.VkontakteLink, "https://bobr.by/data/internet95.gif");
		...
		content += addImageLink("middleSizeIconColumn", "imageLinkWidth", place.Steaks, "https://c7.uihere.com/files/394/835/614/computer-icons-beefsteak-font-others.jpg");
		content += addImageLink("middleSizeIconColumn", "imageLinkWidth", place.Soup, "https://im0-tub-ru.yandex.net/i?id=dbf7d7bdbeb27aaccd0d603192dc11d8&n=13");
		content += addImageLink("middleSizeIconColumn", "imageLinkWidth", place.Breakfast, "https://yt3.ggpht.com/a/AGF-l7-J7zTmBCrgWk3A0RdGxt1kRDZpdTCNl3LGiw=s900-c-k-c0xffffffff-no-rj-mo");
		content += addImageLink("middleSizeIconColumn", "imageLinkWidth", place.Dessert, "https://yt3.ggpht.com/a/AGF-l7-I8FBts-2gH9qr2iB776BWLqj9TXO7oZAH=s900-c-k-c0xffffffff-no-rj-mo");
		content += '<td>';
		if (place.MenuLink)
